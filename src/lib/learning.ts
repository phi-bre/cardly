...
export const levels: Record<CardLevels, CardLevel> = {
  [CardLevels.New]: { title: 'New', timing: get(timings).new },
  [CardLevels.Learning]: { title: 'Learning', timing: get(timings).learning },
  [CardLevels.Reviewing]: { title: 'Reviewing', timing: get(timings).reviewing },
  [CardLevels.Mastered]: { title: 'Mastered', timing: get(timings).mastered },
};
